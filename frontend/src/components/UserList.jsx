import React, { useEffect, useState } from 'react';
  ...
  // If response says no update was needed (like no change), just exit silently
  if (errorText.toLowerCase().includes("no changes") || errorText.toLowerCase().includes("not modified")) {
    handleCancelEdit();
    return;
  }
